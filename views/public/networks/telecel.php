<div class="container mx-auto px-4 py-6">
    <div class="text-center mb-8">
        <h1 class="text-4xl font-bold text-gray-800">Telecel Bundles</h1>
    </div>
    ...
    <?php if (empty($products)): ?>
        <div class="bg-white rounded-xl shadow-sm p-12 text-center border border-gray-100">
            ...
            <p class="text-gray-500">There are currently no products for Telecel.</p>
        </div>
    <?php else: ?>
        ...
        buyNowButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                if (productId && productName && productPrice && window.showPurchaseModal) {
                    ...
                    console.error('Missing product information or modal function');
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'Unable to process purchase. Please try again or refresh the page.'
